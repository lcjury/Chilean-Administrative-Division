...
$Chile = [
  ...
  'Región de Valparaíso' => [
    ...
    'San Antonio' => ['San Antonio','Algarroo','Cartagena','El Quisco','El Tabo','Santo Domingo'],
    'San Felipe de Aconcagua' => ['San Felipe','Catemu','Llaillay','Panquehue','Putaendo','Santa María'],
    'Marga Marga' => ['Limache','Quilpué','Villa Alemana','Olmué']
  ],
  ...
  'Región del Bío-Bío' => [
    ...
    'Arauco' => ['Lebu','Arauco','Cañete','Contulmo','Curanilahue','Los Alamos','Tirúa'],
    'Biobío' => ['Los Angeles','Antuco','Cabrero','Laja','Mulchén','Nacimiento','Negrete','Quilaco','Quilleco','San Rosendo','Santa Bárbara','Tucapel','Yumbel','Alto Biobío'],
  ...
  'Región de Magallanes y la Antártica Chilena' => [
    ...
    'Antártica Chilena' => ['Cabo de Hornos (Ex-Navarino)','Antártica'],
